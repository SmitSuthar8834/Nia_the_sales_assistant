...
def test_lead_extraction():
    ...
    try:
        ...
        print(
            f"   Contact: {lead_info.get('contact_details', {}).get('name', 'Not found')}"
        )
        print(
            f"   Email: {lead_info.get('contact_details', {}).get('email', 'Not found')}"
        )
        print(
            f"   Phone: {lead_info.get('contact_details', {}).get('phone', 'Not found')}"
        )
