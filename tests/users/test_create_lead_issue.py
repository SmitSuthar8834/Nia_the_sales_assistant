    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if "lead_information" in data:
                ...
                print(
                    f"   - pain_points: {len(lead_info.get('pain_points', []))} items"
                )
                print(
                    f"   - requirements: {len(lead_info.get('requirements', []))} items"
                )
            else:
            ...
            if "requirements" in data:
                print(
                    f"✅ Has direct 'requirements': {len(data['requirements'])} items"
                )
            else:
