    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(help_text="Default configuration values"),
                ),
                (
                    "ui_schema",
                    models.JSONField(help_text="UI schema for form generation"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "configuration",
                    models.JSONField(help_text="Integration configuration data"),
                ),
                (
                    "credentials",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="admin_config.configurationtemplate",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "workflow_steps",
                    models.JSONField(help_text="Workflow steps definition"),
                ),
                (
                    "visual_config",
                    models.JSONField(
                        default=dict, help_text="Visual editor configuration"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="admin_config.integrationconfiguration"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="tests",
                        to="admin_config.integrationconfiguration",
                    ),
                ),
                (
                    "triggered_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "configurations",
                    models.JSONField(help_text="Backed up configurations"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="config_permissions",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            options={
                "unique_together": {
                    ("user", "permission_type", "resource_type", "object_id")
                },
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="admin_confi_content_d7865e_idx",
                    ),
                    models.Index(
                        fields=["user", "timestamp"],
                        name="admin_confi_user_id_313f58_idx",
                    ),
                    models.Index(
                        fields=["action", "timestamp"],
                        name="admin_confi_action_365df1_idx",
                    ),
                ],
            },
        ),
