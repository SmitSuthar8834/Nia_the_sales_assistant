...
class ConfigurationTemplate(models.Model):
    ...
    configuration_schema = models.JSONField(
        help_text="JSON schema for configuration validation"
    )
...
class IntegrationConfiguration(models.Model):
    ...
    template = models.ForeignKey(
        ConfigurationTemplate, on_delete=models.SET_NULL, null=True, blank=True
    )

    # Ownership and permissions
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="created_integrations"
    )
...
class WorkflowConfiguration(models.Model):
    ...
    visual_config = models.JSONField(
        help_text="Visual editor configuration", default=dict
    )
...
class RolePermission(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="config_permissions"
    )
    ...
    conditions = models.JSONField(
        default=dict, help_text="Additional permission conditions"
    )
...
class ConfigurationTest(models.Model):
    ...
    configuration = models.ForeignKey(
        IntegrationConfiguration, on_delete=models.CASCADE, related_name="tests"
    )
