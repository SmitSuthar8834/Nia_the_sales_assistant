...
urlpatterns = [
    ...
    path(
        "session/<str:session_id>/status/", views.session_status, name="session_status"
    ),
    ...
    path(
        "session/<str:session_id>/context/",
        views.conversation_context,
    ...
    path(
        "session/<str:session_id>/audio-files/",
        views.session_audio_files,
        name="session_audio_files",
    ),
    path(
        "session/<str:session_id>/audio/<str:filename>/",
        views.download_audio_file,
    ...
    path(
        ...
        chat_views.get_chat_session,
        name="get_chat_session",
    ),
    path(
        "chat/session/<str:session_id>/end/",
        chat_views.end_chat_session,
        name="end_chat_session",
    ),
    path(
        "chat/session/<str:session_id>/upload/",
        chat_views.upload_chat_file,
        name="upload_chat_file",
    ),
    path(
        "chat/session/<str:session_id>/analytics/",
        chat_views.get_chat_analytics,
