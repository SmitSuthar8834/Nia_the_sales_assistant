    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "speaker",
                    models.CharField(
                        choices=[("user", "User"), ("nia", "NIA")], max_length=10
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "voice_name",
                    models.CharField(default="en-US-Wavenet-D", max_length=50),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "status"], name="voice_servi_user_id_1776eb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="callsession",
            index=models.Index(
                fields=["start_time"], name="voice_servi_start_t_6d9c5f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="audiochunk",
            index=models.Index(
                fields=["session", "chunk_number"],
                name="voice_servi_session_4bb395_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="audiochunk",
            index=models.Index(
                fields=["is_processed"], name="voice_servi_is_proc_1c76d7_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["session", "turn_number"], name="voice_servi_session_69d881_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="conversationturn",
            index=models.Index(
                fields=["speaker"], name="voice_servi_speaker_1cf622_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="conversationturn",
