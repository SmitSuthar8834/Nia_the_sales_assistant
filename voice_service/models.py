...
class CallSession(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="call_sessions"
    )
...
class AudioChunk(models.Model):
    ...
    session = models.ForeignKey(
        CallSession, on_delete=models.CASCADE, related_name="audio_chunks"
    )
...
class ConversationTurn(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    session = models.ForeignKey(
        CallSession, on_delete=models.CASCADE, related_name="conversation_turns"
    )
...
class VoiceConfiguration(models.Model):
    ...
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="voice_config"
    )
