...
class CallSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Session Info", {"fields": ("session_id", "user", "status", "caller_id")}),
        ("Timing", {"fields": ("start_time", "end_time", "call_duration")}),
        (
            "Metadata",
            {
                "fields": (
...
class AudioChunkAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Chunk Info", {"fields": ("id", "session", "chunk_number", "timestamp")}),
        (
            "Audio Data",
            {
...
class ConversationTurnAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("content", "audio_url")}),
        (
            "Processing",
            {
                "fields": (
