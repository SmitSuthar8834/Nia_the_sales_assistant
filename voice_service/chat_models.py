...
class ChatSearchHistory(models.Model):
    ...
    session = models.ForeignKey(ChatSession, on_delete=models.CASCADE, related_name='search_history')
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='chat_searches')
