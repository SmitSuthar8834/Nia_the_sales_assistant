...
def test_ai_backend():
    ...
    try:
        ...
        result = subprocess.run([sys.executable, "test_ai_api.py"], 
...
def test_api_endpoints():
    ...
    try:
        result = subprocess.run([sys.executable, "test_frontend_api.py"], 
...
def test_frontend_interface():
    ...
    try:
        result = subprocess.run([sys.executable, "test_frontend_interface.py"], 
...
def manual_test_instructions():
    ...
    print("-" * 40)
    print("""Sales Rep (Sarah): Good afternoon, Mr. Rodriguez. Thank you for taking the time to meet with me today. I understand from our initial conversation that DataFlow Solutions is experiencing some challenges with your current customer management processes?
