    ...
    test_leads_data = [
        {
            ...
            'status': 'qualified',
            'source': 'phone_call',
            'pain_points': ['Outdated CRM system', 'Poor lead tracking', 'Manual processes'],
            'requirements': ['Modern CRM solution', 'Sales automation', 'Analytics dashboard'],
            'budget_info': '$50,000',
            'timeline': '3 months',
            'urgency_level': 'high',
            ...
            'ai_insights': {
                ...
                'key_strengths': ['Strong budget', 'Clear pain points', 'Decision maker engaged'],
                'recommended_actions': ['Schedule product demo', 'Prepare ROI analysis', 'Connect with technical team'],
                'next_steps': ['Schedule product demo', 'Prepare ROI analysis', 'Connect with technical team'],
                'primary_strategy': 'roi_focused',
                'key_messaging': ['ROI and efficiency gains', 'Integration capabilities', 'Proven results'],
                'industry_insights': {'trend': 'Manufacturing companies prioritize ERP integration', 'priority': 'efficiency'}
            }
        },
        {
            ...
            'ai_insights': {
                ...
                'key_strengths': ['Growth potential', 'Tech-savvy team', 'Quick decision making'],
                'recommended_actions': ['Send startup package information', 'Schedule technical consultation', 'Provide case studies'],
                'next_steps': ['Send startup package information', 'Schedule technical consultation', 'Provide case studies'],
                'primary_strategy': 'growth_focused',
                'key_messaging': ['Scalability and growth support', 'Startup-friendly pricing', 'Rapid implementation'],
                'industry_insights': {'trend': 'Tech startups value rapid implementation', 'priority': 'scalability'}
            }
        },
        {
            ...
            'requirements': ['Multi-location CRM', 'Inventory sync', 'Regional reporting'],
            'budget_info': '$100,000',
            'timeline': '6 months',
            'urgency_level': 'low',
            'conversation_history': [
            ...
            'ai_insights': {
                ...
                'key_strengths': ['Large budget', 'Multi-location needs', 'Established company'],
                'recommended_actions': ['Prepare multi-location demo', 'Research their current systems', 'Schedule follow-up in 2 weeks'],
                'next_steps': ['Prepare multi-location demo', 'Research their current systems', 'Schedule follow-up in 2 weeks'],
                'primary_strategy': 'enterprise_focused',
                'key_messaging': ['Multi-location capabilities', 'Integration features', 'Enterprise support'],
                'industry_insights': {'trend': 'Retail companies need extensive integration', 'priority': 'multi_location'}
            }
        },
        {
            ...
            'requirements': ['HIPAA-compliant CRM', 'Secure data handling', 'Patient communication'],
            'budget_info': '$30,000',
            'timeline': '4 months',
            'urgency_level': 'high',
            'conversation_history': [
            ...
            'ai_insights': {
                ...
                'key_strengths': ['Clear compliance needs', 'Budget available', 'Urgency'],
                'recommended_actions': ['Document lessons learned', 'Improve healthcare positioning', 'Follow up in 6 months'],
                'next_steps': ['Document lessons learned', 'Improve healthcare positioning', 'Follow up in 6 months'],
                'primary_strategy': 'compliance_focused',
                'key_messaging': ['HIPAA compliance', 'Security features', 'Healthcare expertise'],
                'industry_insights': {'trend': 'Healthcare prioritizes compliance', 'priority': 'security'}
            }
        },
        {
            ...
            'requirements': ['Client portal', 'Compliance features', 'Document management'],
            'budget_info': '$75,000',
            'timeline': '3 months',
            'urgency_level': 'high',
            'conversation_history': [
            ...
            'ai_insights': {
                ...
                'sales_cycle_prediction': '2-3 months',
                'key_strengths': ['Strong budget', 'Compliance focus', 'Decision maker buy-in', 'Clear requirements'],
                'recommended_actions': ['Begin implementation planning', 'Assign customer success manager', 'Schedule training sessions'],
                'next_steps': ['Begin implementation planning', 'Assign customer success manager', 'Schedule training sessions'],
                'primary_strategy': 'relationship_focused',
                'key_messaging': ['Compliance features', 'Premium support', 'Financial expertise'],
                'industry_insights': {'trend': 'Financial services value compliance', 'priority': 'specialized_features'}
            }
        }
    ]
