        ...
        if email:
            ...
            try:
                ...
                raise serializers.ValidationError(
                    "Invalid email format in contact_info"
                )
...
class ConversationAnalysisSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "conversation_text", "extracted_data", "analysis_timestamp"]
...
# Opportunity serializers removed - models were not being used in the application
# This simplifies the codebase and focuses on core Lead and AI functionality
