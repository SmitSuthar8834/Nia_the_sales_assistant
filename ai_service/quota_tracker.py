...
class GeminiQuotaTracker:
    ...
    def __init__(self):
        ...
        self.token_per_minute_limit = getattr(settings, 'GEMINI_TOKEN_MINUTE_LIMIT', 1000000)
    ...
    def get_current_usage(self):
        ...
        return {
            ...
            'token_minute_remaining': max(0, self.token_per_minute_limit - minute_tokens),
            'usage_percentage': {
    ...
    def record_request(self, tokens_used=1000):
        ...
        cache.set(token_minute_key, cache.get(token_minute_key, 0) + tokens_used, timeout=120)
