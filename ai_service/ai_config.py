...
INDUSTRY_CUSTOMIZATION = {
    "technology": {
        ...
        "common_objections": ["integration_complexity", "technical_debt", "resource_allocation"],
        "success_metrics": ["developer_productivity", "system_performance", "integration_speed"]
    },
    
    "financial_services": {
        "emphasis": "compliance_and_roi",
        "key_stakeholders": ["CFO", "CRO", "Head of Operations", "Compliance Officer"],
        "common_objections": ["regulatory_concerns", "security_requirements", "change_management"],
        "success_metrics": ["compliance_score", "operational_efficiency", "risk_reduction"]
    },
    
    "healthcare": {
        "emphasis": "patient_outcomes",
        "key_stakeholders": ["CMO", "CIO", "Administrator", "Department Head"],
        "common_objections": ["hipaa_compliance", "workflow_disruption", "training_requirements"],
        "success_metrics": ["patient_satisfaction", "workflow_efficiency", "compliance_adherence"]
    }
}
...
def get_industry_config(industry: str):
    ...
    return INDUSTRY_CUSTOMIZATION.get(industry_key, INDUSTRY_CUSTOMIZATION['technology'])
