...
def analyze_lead_with_ai(self, lead_id, conversation_text=None):
    ...
    try:
        ...
        sales_strategy = ai_service.generate_sales_strategy(extracted_data, quality_score)
...
def _build_insights_data(quality_score, recommendations, sales_strategy, industry_insights):
    ...
    return {
        ...
        'data_completeness': quality_score.get('validation_metadata', {}).get('confidence_level', 50),
