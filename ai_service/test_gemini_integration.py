...
class GeminiAIIntegrationTestCase(TestCase):
    ...
    def test_entity_recognition_contacts(self):
        ...
        text = "Contact John Smith at john.smith@company.com or call him at 555-987-6543."
    ...
    def test_data_completeness_calculation(self):
        ...
        partial_completeness = self.ai_service._calculate_data_completeness(partial_data)
    ...
    def test_api_key_rotation(self, mock_model, mock_configure):
        ...
        with patch.object(ai_service, '_rotate_api_key', return_value=True) as mock_rotate:
            try:
        ...
        self.test_conversations = [
            {
                ...
                'expected_fields': ['company_name', 'contact_name', 'budget_info', 'timeline', 'email', 'phone']
            },
            {
            ...
            },
            {
                ...
                'expected_fields': ['company_name', 'contact_name', 'title', 'company_size', 'pain_points', 'requirements', 'budget_info', 'timeline', 'decision_makers', 'current_solution', 'competitors_mentioned']
            }
        ]
