    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(blank=True, help_text='How this lead was acquired', max_length=100)),
                ...
                ('timeline', models.CharField(blank=True, help_text='Project timeline or urgency', max_length=255)),
                ('decision_makers', models.JSONField(default=list, help_text='Names or roles of decision makers')),
                ('urgency_level', models.CharField(blank=True, choices=[('high', 'High'), ('medium', 'Medium'), ('low', 'Low')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quality_tier', models.CharField(choices=[('high', 'High'), ('medium', 'Medium'), ('low', 'Low')], default='medium', max_length=10)),
                ('score_breakdown', models.JSONField(default=dict, help_text='Detailed scoring breakdown')),
                ('estimated_deal_size', models.CharField(blank=True, help_text='Predicted deal value range', max_length=100)),
                ('sales_cycle_prediction', models.CharField(blank=True, help_text='Expected sales cycle duration', max_length=100)),
                ...
                ('competitive_risk', models.CharField(choices=[('high', 'High'), ('medium', 'Medium'), ('low', 'Low')], default='medium', max_length=10)),
                ...
                ('primary_strategy', models.CharField(blank=True, help_text='Recommended sales approach', max_length=50)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('lead', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ai_insights', to='ai_service.lead')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='lead',
            index=models.Index(fields=['user', 'status'], name='ai_service__user_id_c89d44_idx'),
        ),
        migrations.AddIndex(
            model_name='lead',
            index=models.Index(fields=['company_name'], name='ai_service__company_46038d_idx'),
        ),
        migrations.AddIndex(
            model_name='lead',
            index=models.Index(fields=['created_at'], name='ai_service__created_67de01_idx'),
        ),
    ]
